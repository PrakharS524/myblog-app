  ...
  return (
    <div className='py-5 px-5 md:px-12 lg:px-28'>
      <div className='flex justify-between items-center'>
        <Image src={assets.logo} width={100} alt='' className='w-[150px] sm:w-auto'/>
      ...
      <div className='text-center mt-8'>
        ...
        <p className='mt-10 max-w-[740px] m-auto text-xs sm:text-base'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed omnis commodi minima eius totam culpa. Reprehenderit eos maxime, ullam mollitia, voluptates iste dignissimos voluptas aut consequatur recusandae iusto impedit molestias?</p>
